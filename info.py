...
API_ID = int(environ.get('API_ID', '25779426'))
API_HASH = environ.get('API_HASH', '7153fde453f87ae1e64fd45be566e9d0')
BOT_TOKEN = environ.get('BOT_TOKEN', "7504852307:AAGxY-Synv8XpJVknQIKauHfoJe1-EEZI2A")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '1002214407806'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '2097646267').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS','@apka22051002214407806').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://nikhilsabban56:Ku1ks3q1BUH9SdHX@cluster0.xxqun.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
